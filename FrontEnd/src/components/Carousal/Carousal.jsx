          ...
          >
            {imageList[currentIndex]?.src ? (
              ...
              <div style={styles.placeholderImage}>
                {imageList[currentIndex]?.placeholder || `Image ${currentIndex + 1}`}
              </div>
            )}
          </motion.div>
        </AnimatePresence>
...
const Carousel = () => {
  ...
  const sampleImages = [
    { id: 1, src: 'https://picsum.photos/800/400?random=1', alt: 'Random Image 1' },
    { id: 2, src: 'https://picsum.photos/800/400?random=2', alt: 'Random Image 2' },
    { id: 3, src: 'https://picsum.photos/800/400?random=3', alt: 'Random Image 3' },
    { id: 4, src: 'https://picsum.photos/800/400?random=4', alt: 'Random Image 4' },
  ];
