...
export default function ContactForm() {
  ...
  const handleSubmit = (e) => {
    ...
    alert(
      "Contact request submitted! Our holiday expert will contact you soon."
    );
  };
  ...
  return (
    ...
    >
      <div
        ...
        >
        {/* RIGHT COLUMN - Form */}
        <div style={{ flex: "1 1 30%", minWidth: "300px", border:"2px solid black" }}>
          <motion.form
          ...
          >
            ...
            <motion.button
              ...
              onMouseOver={(e) =>
                (e.target.style.backgroundColor = "#61daffff")
              }
        ...
        {/* LEFT COLUMN - Header */}
        <div style={{ flex: "1 1 50%", minWidth: "300px" , border:"2px solid black", }}>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p style={{ fontWeight: 600, margin: "0 0 4px" }}>Why Choose Us?</p>
            <p
              style={{ color: "#666", fontSize: "13px", marginBottom: "12px" }}
            >
              Expert travel planning, personalized itineraries, and 24/7 support
